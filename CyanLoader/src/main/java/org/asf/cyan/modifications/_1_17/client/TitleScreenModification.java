...
public class TitleScreenModification {
	...
	public void render1(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var1, int var2, int var3, float var4,
		...
		drawCyanInfo(var1, var10);
	}

	public void drawCyanInfo(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var1, int var10) {
	...
	@TargetName(target = "render")
	public void render2(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var1, int var2, int var3,
			float var4) {
		height = height + 10;
	}
