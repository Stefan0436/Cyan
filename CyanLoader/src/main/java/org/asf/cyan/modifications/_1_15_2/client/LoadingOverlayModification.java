...
public class LoadingOverlayModification {
	...
	@Reflect
	public static void drawString(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var0,
			@TargetType(target = "net.minecraft.client.gui.Font") Object var1, String var2, int var3, int var4,
			int var5) {
	}

	@Reflect
	public static void drawCenteredString(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var0,
			@TargetType(target = "net.minecraft.client.gui.Font") Object var1, String var2, int var3, int var4,
			int var5) {
	}

	@Reflect
	public static void drawProgressBar(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var1,
			int var2, int var3, int var4, int var5, float var6) {
	}
	...
	public void drawProgressBar(@TargetType(target = "com.mojang.blaze3d.vertex.PoseStack") Object var1, int var2,
			int var3, int var4, int var5, float var6, @LocalVariable int var7, @LocalVariable int var8,
