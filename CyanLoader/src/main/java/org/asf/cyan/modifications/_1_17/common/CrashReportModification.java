...
import org.asf.cyan.modifications._1_17.typereplacers.CrashReportCategoryMock;
...
//	}
	...
	private void initDetails(String var1, Throwable var2) {
		boolean trackOld = trackingStackTrace;
		trackingStackTrace = false;
		coremodsCategoryCyanLoader = new CrashReportCategoryMock("Loaded CYAN Coremods");
		modsCategoryCyanLoader = new CrashReportCategoryMock("Loaded CYAN Mods");
