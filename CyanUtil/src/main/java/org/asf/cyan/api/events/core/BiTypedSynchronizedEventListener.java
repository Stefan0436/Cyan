...
/**
 * 
 * Modloader Event Listener with two type arguments that does not run in its own
 * thread.
 * 
 * @author Stefan0436 - AerialWorks Software Foundation
 * 
 */
public interface BiTypedSynchronizedEventListener<T1, T2> extends ISynchronizedEventListener {
